...
export function generateTradeReceiptPdf(transaction: TransactionRecord): Uint8Array {
  ...
  const streamCommands: string[] = [
    ...
    "0.3 0.35 0.4 rg",
    "55 284 Td",
    `[Bank Reference: ${escapePdf(transaction.paymentReference || "SETU-NEFT-2026-9F4A28B1")}] Tj`,
    "ET",
    "BT",
    "/F1 8.5 Tf",
    "0.35 0.4 0.45 rg",
    "55 268 Td",
    "(Digital Verification Ref: TXN-SETU-2026-SIH26132-VERIFIED) Tj",
    "ET",
    "BT",
    "/F1 8.5 Tf",
    "0.4 0.45 0.5 rg",
    "55 252 Td",
    "(Authenticated through KissanSetuAI Smart India Hackathon 2026 Engine) Tj",
    "ET",
    "BT",
    "/F1 8 Tf",
    "0.5 0.55 0.6 rg",
